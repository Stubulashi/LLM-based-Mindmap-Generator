...
|---|---|---|---|
| **example** 节点标签 / Node Label | **example** Node-F1 | **example** 0.273 | **example** ⚠️ Needs Improvement / 需改进 |
| **example** 层级结构 / Hierarchy | **example** Edge-F1 | **example** 0.000 | **example** ⚠️ Needs Improvement / 需改进 |
| **example** 层级结构 / Hierarchy | **example** UAS | **example** 0.000 | **example** ⚠️ Needs Improvement / 需改进 |
| **example** 层级结构 / Hierarchy | **example** nTED | **example** 0.727 | **example** ⚠️ Needs Improvement / 需改进 |
...
> **⚠️ Node-F1 Needs Improvement (0.273)**. Node labels have low match rate with gold standard. Check concept extraction for missed concepts and LLM output for redundant nodes.
> **⚠️ Entity Recall Needs Improvement (0.360)**. Key concepts missing: 机器学习基础, 机器学习, Machine Learning, 监督学习, Supervised Learning. Check STT transcription for these terms.
> **⚠️ High FP (8)**. Generated map has redundant nodes. Tighten concept extraction threshold or reduce LLM over-generation.
> **⚠️ Edge-F1 Needs Improvement (0.000)**. Hierarchy has significant deviations. Check hierarchy planning stage for correct parent-child relationships.
> **⚠️ UAS Needs Improvement (0.000)**. Multiple nodes have incorrect parent assignments. Check hierarchy planning quality.

---
*报告生成时间 / Report Generated: 2026-07-02 16:32:06*
